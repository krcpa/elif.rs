...
mod tests {
    ...
    fn test_query_pattern_validation_detects_attacks() {
        ...
        assert!(validate_query_pattern("SELECT * FROM users UNION ALL SELECT password FROM admin").is_err());
    ...
    fn test_parameter_binding_security() {
        ...
        for test_case in test_cases {
            ...
            assert!(validate_parameter(test_case).is_ok(), 
                "Parameter validation failed for: {}", test_case);
        }
    }
