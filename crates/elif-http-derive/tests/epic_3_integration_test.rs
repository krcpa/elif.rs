...
use elif_core::modules::{
    ModuleDescriptor, ServiceDescriptor, ServiceLifecycle,
    ModuleAutoConfiguration, ModuleComposition, ModuleDependencyValidator
};
...
mod tests {
    ...
    fn test_epic_3_module_descriptor_generation() {
        ...
        let user_service = providers.iter()
        ...
        let repo_service = providers.iter()
        ...
        assert!(descriptor.exports.contains(&"TestSqlRepository".to_string()));
    }
    ...
    fn test_epic_3_module_composition() {
        ...
        let composition = ModuleComposition::new()
            ...
            .with_overrides(vec![
                ServiceDescriptor::new::<TestUserService>("OverrideService", ServiceLifecycle::Singleton)
            ]);
    ...
    fn test_epic_3_topological_sort() {
        ...
        assert!(database_pos < business_pos, 
    ...
    fn test_epic_3_complex_composition_scenario() {
        ...
        let composition = ModuleComposition::new()
            ...
            .with_module(TestModule::module_descriptor())
            .with_overrides(vec![
                ServiceDescriptor::new::<TestUserService>("OverrideUserService", ServiceLifecycle::Transient)
                    .with_name("business")
            ]);
        ...
        assert!(result.is_ok(), "Complex composition should succeed: {:?}", result);
        ...
        let has_override = final_descriptor.providers.iter()
            .any(|p| p.service_name == "OverrideUserService" && 
                    p.name.as_deref() == Some("business"));
    ...
    fn test_epic_3_duplicate_exports_detection() {
        ...
        let duplicate_export_module = ModuleDescriptor::new("DuplicateModule")
            .with_exports(vec![
                "Service1".to_string(),
                "Service2".to_string(), 
