...
fn create_benchmark_module(
    ...
    let mut module = ModuleDescriptor::new(name)
        ...
        .with_description(format!("Benchmark module {} with {} services", name, service_count));
        ...
        group.bench_with_input(
            ...
            |b, &size| {
                ...
                for i in 0..size {
                    ...
                    runtime.register_module(create_benchmark_module(
                        &format!("Module{}", i),
                        deps,
                ...
                b.iter(|| {
                    ...
                    for i in 0..size {
                        ...
                        runtime_clone.register_module(create_benchmark_module(
                            &format!("Module{}", i),
                            deps,
                            2,
                        )).unwrap();
            ...
            |b, &size| {
                b.iter(|| {
                    ...
                    for i in 0..top_modules {
                        let deps = vec![
                            format!("Middle{}", i % middle_modules),
                        ];
                        runtime.register_module(create_benchmark_module(
                            &format!("Top{}", i),
                            deps,
    ...
    group.bench_function("module_setup_parallel", |b| {
        b.iter(|| {
            ...
            for i in 0..50 {
                runtime.register_module(create_benchmark_module(
                    &format!("Module{}", i),
                    if i == 0 { vec![] } else { vec![format!("Module{}", i - 1)] },
                    2,
                )).unwrap();
            }
