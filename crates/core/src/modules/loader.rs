...
impl ModuleLoader {
    ...
    pub fn print_summary(&self) {
        ...
        println!("  - Dependency resolution: {:?}", stats.dependency_resolution_time);
...
impl LoadingStats {
    ...
    pub fn phase_percentages(&self) -> PhasePercentages {
        ...
        PhasePercentages {
            ...
            dependency_resolution: (self.dependency_resolution_time.as_micros() as f64 / total_micros) * 100.0,
