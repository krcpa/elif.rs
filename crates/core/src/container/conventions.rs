...
impl ServiceConventions {
    ...
    pub fn add_naming_convention(&mut self, pattern: &str, lifetime: ServiceScope) -> &mut Self {
        self.naming_conventions.insert(pattern.to_string(), lifetime);
        self
    }
    ...
    pub fn get_lifetime_for_type(&self, type_name: &str) -> ServiceScope {
        // Check custom rules first (higher priority than naming conventions)
...
mod tests {
    ...
    fn test_naming_conventions() {
        ...
        assert_eq!(conventions.get_lifetime_for_type("SomeRandomType"), ServiceScope::Transient);
    }
    ...
    fn test_custom_convention_rules() {
        ...
        assert_eq!(conventions.get_lifetime_for_type("UserDbContext"), ServiceScope::Scoped);
        assert_eq!(conventions.get_lifetime_for_type("ConnectionPool"), ServiceScope::Scoped);
    }
