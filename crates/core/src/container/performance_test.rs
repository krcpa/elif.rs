...
mod tests {
    ...
    fn test_resolve_named_accepts_str_slice() {
        ...
        let service = container
            .resolve_named::<TestService>(service_name)
            .unwrap();
    ...
    fn test_str_slice_vs_owned_string_compatibility() {
        ...
        let service_1 = container
            .resolve_named::<TestService>("test_service")
            .unwrap(); // &str literal

        let name_string = String::from("test_service");
        let service_2 = container
            .resolve_named::<TestService>(&name_string)
            .unwrap(); // &String -> &str
